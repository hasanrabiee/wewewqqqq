        ...
        <div class="container my-auto text-center">
            ...
            <div style="background-color: rgb(54,54,54,65%);width: 1117px;height: 397px;margin-right: 10px;">
                <div class="text-left" style="padding: 39px;padding-top: 49px;">
                    <h3 style="color: rgb(255,255,255);">{{__('message.AccountActivationHead')}}
                        <i class="fa fa-check" style="color: rgb(21,241,2);"></i></h3>
                    <h4 class="text-break" style="color: rgb(255,255,255);">{!! __('message.AccountActivationBody1') !!}</h4>
                    <h4 class="text-light" >{!! __('message.AccountActivationBody2') !!}</h4>
                </div>
                <a class="remove_underline" href="{{ route('logout') }}" style="font-size: 15px;color: #c5c5c5;margin-bottom: 16px;" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><button class="btn btn-danger">{{__('message.LogOut')}}</button></a>
